...
import pandas as pd
from eks import ekstrak
from cls import predict_knn
...
class Utama():
    ...
    def load_img(self):
        if os.path.isfile('temp/file.png'):
            os.remove('temp/file.png')
        ...
        im.save(f'temp/file.png')
        self.myPic = tk.PhotoImage(file='temp/file.png')
        self.img.delete("all")
